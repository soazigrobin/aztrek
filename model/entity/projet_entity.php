...
function getProject(int $id = 999): array {
    ...
    $query = "SELECT 
                ...
                REPLACE(FORMAT(projet.prix, 0, 'de_DE'), '.','') AS prix_format,
...
/* @var $connexion PDO*/
    ...
    $query = "INSERT INTO projet (titre, image, date_debut, date_fin, prix, description, categorie_id) VALUES (:titre, :image, :date_debut, :date_fin, :prix, :description, :categorie_id)";
